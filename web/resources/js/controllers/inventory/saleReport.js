...
$(document).ready(function () {
    ...
    /* Init the table */
    var urlReloadTable = contextServices + "sale/listSaleReport?branchId=" + $('#branch').val()+"&type="+$('#type').val()+"&search="+$('#search').val();
...
function reloadSearch() {
    var url = contextServices + "sale/listSaleReport?branchId=" + $('#branch').val()+"&type="+$('#type').val()+"&search="+$('#search').val();
...
function openDetailCredit(link) {
    ...
    $.ajax({
        url: contextServices + "sale/salePaymentsReport",
        data: {salId: salId, creditId: creditId},
        type: 'GET',
        dataType: 'json',
        success: function (data) {
            $("#detailReivoce").html(tempSaleRevoiceReport(data));
