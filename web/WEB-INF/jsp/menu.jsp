...
<script src="<c:url value='/resources/js/libs/moment.min.js'/>"></script>
...
<div id='cssmenu'>
    <ul>
        ...
        <li class='has-sub'><a href='#' onclick="redirectSales();
                return false;"><span>Ventas</span></a>
            <ul>
                ...
                <li class='last'><a href='#' onclick="redirectSaleReceive();
                        return false;"><span>Cobro de ventas</span></a></li>
                <li class='last'><a href='#' onclick="redirectSaleReport();
                        return false;"><span>Reporte de ventas</span></a></li>
            </ul>
        </li>
